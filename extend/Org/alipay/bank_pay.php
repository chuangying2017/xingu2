...
///////////////////////////  初始化接口参数  //////////////////////////////
/**
接口参数请参考智汇付网银支付文档，除了sign参数，其他参数都要在这里初始化
*/
...
?>
<!-- 以post方式提交所有接口参数到智汇付支付网关https://pay.zhihpay.com/gateway?input_charset=UTF-8 -->
<html>
	<head>
    ...
    <body>
		<form name="dinpayForm" method="post" action="https://pay.zhihpay.com/gateway?input_charset=UTF-8" target="_blank">
